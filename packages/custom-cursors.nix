...
let
  ...
  cursors-data =
    ({
      castorice =
        _b "castorice" "https://static.asakiyuki.com/cursors/linux/castorice.tar.gz"
          "sha256-nqAC+Itr+TXLGG8zYDBoBve+MeRckds5BM23DrsCTMM=";

      aemeath =
        _b "aemeath" "https://static.asakiyuki.com/cursors/linux/aemeath.tar.gz"
          "sha256-0eEsUks5MwW4g5Xau24SgchX+LD9Ra3azAH0KL9JzQw=";

      elysia =
        _b "elysia" "https://static.asakiyuki.com/cursors/linux/elysia.tar.gz"
          "sha256-mjDHklWrX5Pp/vejRQiMk0VA6afY04HXGyGD0PcopdI=";

      cartethyia =
        _b "cartethyia" "https://static.asakiyuki.com/cursors/linux/cartethyia.tar.gz"
